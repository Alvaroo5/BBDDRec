-- 1. Mostrar los nombres de los equipos y el número total de goles marcados por cada uno en todos los partidos de manera descendiente.
...
group by nombre_estadio, e.telefono 
